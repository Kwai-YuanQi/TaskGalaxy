...
if __name__ == "__main__":
    ...
    run_caption(model, tokenizer, input_file, "TaskGalaxy/DatasetPipeline/Step3/Dataset/task_related_dataset_4o_qa_forfilter_internvl.json")